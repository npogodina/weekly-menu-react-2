...
import { Item, Card, Container, Grid } from "semantic-ui-react";
import "./Home.css";
                ...
                <Item.Content>
                  ...
                  <Item.Description>
                    ...
                    <p>
                      ...
                      plan to keep working on the project and add more features,
                      and I have no intention to turn it off. You are also very
                      welcome to reach out with any feedback using the contact
                    ...
                    <p>
                      ...
                      . The back end was made using AWS serverless stack: AWS
                      Lambda (JS), API Gateway and DynamoDB. The front end is in
                      React.
                    </p>
                    <p>
                      Ada Developers Academy is a non-profit tuition-free
                      intensive coding school for women and gender diverse
                      people. It combines six months of classroom training with
                      a five month internship at Seattle tech companies. As a
                      culmination of the classroom learning experience, students
                      create a Capstone project where they are encouraged to
                      learn and implement new technologies. For more information
                      about Ada please visit <span> </span>
                      <a
                        target="_blank"
